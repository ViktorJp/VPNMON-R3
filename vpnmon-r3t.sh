...
progressbaroverride() 
{
  ...
  if [ $key_press ]; then
      case $key_press in
          [1]) echo ""; restartvpn 1; restartrouting; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [2]) echo ""; restartvpn 2; restartrouting; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [3]) echo ""; restartvpn 3; restartrouting; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [4]) echo ""; restartvpn 4; restartrouting; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [5]) echo ""; restartvpn 5; restartrouting; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [\!]) echo ""; killunmonvpn 1; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [\@]) echo ""; killunmonvpn 2; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [\#]) echo ""; killunmonvpn 3; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [\$]) echo ""; killunmonvpn 4; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [\%]) echo ""; killunmonvpn 5; exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
          [Aa]) autostart;;
          [Cc]) vsetup;;
          [Ee]) echo -e "${CClear}\n"; exit 0;;
  ...
  if [ "$availableslots" == "1 2" ]; then
    ...
    read -p ": " SelectSlot
      case $SelectSlot in
            ...
            [Uu]) vpnserverlistautomation;;
            [Vv]) vpnserverlistmaint;;
            [Nn]) exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
            *) exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch;;
        esac
...
while true; do
  ...
  read -p "Please select? (1-4, e=Exit): " SelectSlot
    case $SelectSlot in
      ...
      3) vupdate;;
      4) vuninstall;;
      [Ee]) #exec sh /jffs/scripts/vpnmon-r3t.sh -noswitch
            echo ""
            timer=$timerloop
            break;;
    esac
